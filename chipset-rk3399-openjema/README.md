## JemaOS for You - Pinebook Pro

This repository holds artefacts for building JemaOS using [cros_sdk](https://chromium.googlesource.com/chromiumos/docs/+/master/developer_guide.md#Building-Chromium-OS), usually provided as a Gentoo ebuild repository.
